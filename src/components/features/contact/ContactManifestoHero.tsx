...
export interface ContactManifestoHeroProps {
  onScrollToForm?: () => void
  className?: string
}
...
/**
 * ContactManifestoHero — "The Conversation Canvas"
 * 12-column asymmetrical hero combining monumental editorial typography
 * with the signature Material Signal architectural visual.
 */
export const ContactManifestoHero: React.FC<ContactManifestoHeroProps> = ({
  onScrollToForm,
  className = '',
}) => {
  ...
  return (
    <section
      aria-label="Design Concierge Hero"
      className={`relative min-h-[68svh] lg:min-h-[76svh] flex flex-col justify-between pt-24 sm:pt-28 pb-10 sm:pb-14 select-none ${className}`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full space-y-8 sm:space-y-10">
        ...
        <div className="flex items-center justify-between gap-4 border-b border-[#1F1F1F] pb-4">
          ...
          <div className="flex items-center gap-2 text-[10px] uppercase font-mono tracking-[0.25em] text-[#C9A84C] font-semibold">
            <span className="w-2 h-2 rounded-full bg-[#C9A84C]" aria-hidden="true" />
            <span className="hidden sm:inline">DESIGN CONCIERGE</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-16 items-center">
          {/* Left Column (Cols 1-7): Editorial Introduction */}
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            ...
            {/* Restrained Factual Introduction */}
            <motion.p
            ...
            >
              Tell us about the piece, room layout, or custom architectural requirement you have in mind. We'll use your details to understand the context and begin the design conversation.
            </motion.p>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4">
              ...
              >
                ...
                <HugeiconsIcon icon={ArrowDown01Icon} className="w-3.5 h-3.5 text-[#C9A84C]" />
              </a>
            </div>
          </div>

          {/* Right Column (Cols 8-12): The Material Signal Visual */}
            ...
            <div className="relative overflow-hidden bg-[#0D0D0D] border border-[#242424] p-2 sm:p-3 shadow-2xl">
              ...
              <div className="aspect-[4/5] sm:aspect-[1/1] lg:aspect-[4/5] overflow-hidden bg-[#141414] relative">
                <img
                  ...
                  alt="Architectural furniture atelier consultation space"
                  loading="eager"
                  fetchPriority="high"
              ...
              <div className="pt-3 px-2 flex items-center justify-between text-[10px] font-mono text-[#7A746B] uppercase tracking-wider">
                <span className="text-[#C9A84C]">BESPOKE COMMISSION</span>
                <span>TAILORED DIMENSIONS</span>
              </div>
            </div>
          </div>
        </div>
...
export default ContactManifestoHero
